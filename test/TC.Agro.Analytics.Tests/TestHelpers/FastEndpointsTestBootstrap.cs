...
namespace TC.Agro.Analytics.Tests.TestHelpers;

/// <summary>
/// One-time initializer for FastEndpoints validation context required by
/// BaseCommandHandler / BaseQueryHandler constructors during unit tests.
/// </summary>
